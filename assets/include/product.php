...
class Product {
    ...
    function __construct(string $input_name, string $classCSS, int $classInt, string $displayCSS, float $input_price, string $category, string $input_image, string $input_description) {
